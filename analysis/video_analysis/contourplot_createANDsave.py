# ---- For every frame, it creates a plot that includes the flame contour, height and depth and saves it.

import matplotlib.pyplot as plt
import numpy as np
import cv2

def createANDsave_plot(flame,roi,experiment, frame, image, heights , depths):
    """
