...
def heightANDdepth(flame, pixel_to_meters, data, roi):
    ...
    # draw circles around the top and bottom of the flame
    ...
    if height_top < 300:
        ...
        cv2.circle(roi, top_point, 7, (0, 0, 255), 3)
        cv2.circle(roi, bottom_point, 7, (0, 0, 255), 3) 
    ...
    return height_top, height_bottom, depth_below, depth_door, depth_above
